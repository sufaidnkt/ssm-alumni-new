...
function eps_diamond_form_system_theme_settings_alter(&$form, &$form_state) {
    //logo icon
    ...
    $form['#submit'][] = 'eps_diamond_settings_submit_logo_icon';
}

function eps_diamond_settings_submit_logo_icon($form, &$form_state) {
    // upload logo icon
