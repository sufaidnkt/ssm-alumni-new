...
#templatePreheader {
  ...
  /*@editable*/ border-bottom: 1px solid #e2e2e2;
}
/**
      * @tab Header
...
.preheaderContent{display: block !important;width:auto;text-align:center;}
.align_resp_cntr{text-align:center !important;}
.btn{margin:0 auto;}
.templateColumnContainer1{
  display: block !important;
  width: 100% !important;
}
/**
          ...
          <tr>
            <td align="center" valign="top"><!-- BEGIN HEADER // -->
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                <tbody>
                  <tr>
                    <td valign="top" class="headerContent" style="background:#166db6;text-align:center;padding:28px;"><h2 style="font-family:Arial, Helvetica, sans-serif;font-size: 28px;font-weight:bold;line-height:30px;text-align:center;color:#fff !important;"><?php print $subject ?></h2></td>
                  </tr>
                </tbody>
              </table>
          ...
          <tr>
            <td align="center" valign="top"><!-- BEGIN BODY // -->
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                <tr>
                  <td valign="top" class="bodyContent" mc:edit="body_content" style="padding:20px 25px 40px 20px;font-family:Arial, Helvetica, sans-serif;font-size:14px;color:#535252;text-align:justify;margin-top:30px; background-color:#FFFFFF; border:1px solid #535252" >
