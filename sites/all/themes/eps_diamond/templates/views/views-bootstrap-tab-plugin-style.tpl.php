<div id="views-bootstrap-tab-<?php print $id ?>" class="tab-container <?php print $classes ?>">
  <ul class="nav nav-tabs nav-<?php print $tab_type?> <?php if ($justified) print 'nav-justified' ?>">
